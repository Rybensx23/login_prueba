...
const buscar = async () => {
    ...
    const url = `/login_prueba/API/clientes/buscar?cliente_nombre=${cliente_nombre}&cliente_nit=${cliente_nit}`;
    // const url = `/login_prueba/API/clientes/buscar`;
...
const guardar = async (evento) => {
    ...
    const url = '/login_prueba/API/clientes/guardar';
...
const modificar = async () => {
    ...
    const body = new FormData(formulario)
    const url = '/login_prueba/API/clientes/modificar';
    const config = {
        method : 'POST',
        body
    }
...
const eliminar = async (e) => {
    ...
    if (await confirmacion('warning', 'Desea elminar este registro?')) {
        ...
        body.append('cliente_id', id)
        const url = '/login_prueba/API/clientes/eliminar';
        const headers = new Headers();
        headers.append("X-Requested-With","fetch");
        const config = {
            method: 'POST',
